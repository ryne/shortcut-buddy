const Shortcut = ({ prompt, id, response }) => {
  return (
    <div
      className={`shortcut ${id} text-left w-11/12 md:w-[640px] lg:w-[800px] p-4 md:p-6 m-1.5 md:m-3 bg-slate-100 dark:bg-slate-700 rounded-lg flex flex-col text-center`}
    >
