...
const Keyboard = () => {
  return (
    <div id="keyboard_base">
      <div className="keyboard layout_mac grid float-left p-2 rounded-lg border-slate-300 border-2 border-b-4 border-solid bg-slate-200 text-slate-800 text-sm gap-1.5">
        ...
        <button className="modifier col-span-3 pt-0.5" title="command">
          <BsCommand />
          cmd
        </button>
