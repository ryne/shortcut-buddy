...
const Keyboard = () => {
  return (
    <div className="keyboard layout_mac">
      ...
      <button className="key col-span-4 pt-1" title="delete">
        <BsFillBackspaceFill />
        delete
      </button>
      <button className="key col-span-3 pt-1" title="tab">
        <MdKeyboardTab />
        tab
      </button>
      ...
      <button className="modifier col-span-4 pt-1" title="caps lock">
        <BsCapslockFill />
        caps lock
      </button>
      ...
      <button className="modifier col-span-4 pt-1" title="return">
        <MdOutlineKeyboardReturn />
        return
      </button>
      <button className="modifier col-span-5 pt-1" title="shift">
        <BsShiftFill />
        shift
      </button>
      ...
      <button className="modifier col-span-2 pt-1" title="control">
        <ImCtrl />
        control
      </button>
      <button className="modifier col-span-2 pt-1" title="option">
        <BsOption />
        option
      </button>
      <button className="modifier col-span-3 pt-1" title="command">
        <BsCommand />
        command
      </button>
      <button className="key col-span-12" title="space bar"></button>
      <button className="modifier col-span-3 pt-1" title="command">
        <BsCommand />
        command
      </button>
