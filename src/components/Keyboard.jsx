const Keyboard = () => {
  return (
    <div class="keyboard layout_mac">
      ...
      <button class="key col-span-12" title="space bar"></button>
      <button class="modifier col-span-3" title="command">
        command
      </button>
      <button class="modifier col-span-2" title="option">
      ...
      <button class="key col-span-1" title="down arrow">
        &darr;
      </button>
      <button class="key col-span-1" title="up arrow">
        &uarr;
      </button>
      <button class="key col-span-1" title="right arrow">
        &rarr;
      </button>
    </div>
  );
